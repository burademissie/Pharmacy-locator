...
// Function to count total medicines
...
// Function to count total pharmacies
function getTotalPharmacies($conn) {
    $stmt = $conn->prepare("SELECT COUNT(*) as total FROM pharmacy");
    $stmt->execute();
    $result = $stmt->get_result();
    $row = $result->fetch_assoc();
    return $row['total'];
...
// Get the counts
$totalMedicines = getTotalMedicines($conn);
$totalPharmacies = getTotalPharmacies($conn);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Med Finder - Pharmacy Dashboard</title>
        ...
        <div class="main-content">
            ...
            <div class="stats-container">
                <div class="stats-card">
                    ...
                    <div class="stats-info">
                        ...
                        <p class="stats-value"><?php echo $totalMedicines?></p>
                    </div>
                </div>
                ...
                <div class="stats-card">
                    ...
                    <div class="stats-info">
                        ...
                        <p class="stats-value"><?php echo $totalPharmacies?></p>
                    </div>
                </div>
            </div>
            ...
            <section id="medicines-section">
                ...
                <div id="notFoundMessage" class="not-found">
                    ...
                    <p>We couldn't find the medicine you're looking for.</p>
                    <p>Please try searching with a different name or check the spelling.</p>
                </div>
            </section>
        </div>
    </div>
